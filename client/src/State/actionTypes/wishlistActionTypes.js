...
export const REMOVE_WISHLIST_ITEMS_REQUEST = "REMOVE_WISHLIST_ITEMS_REQUEST";
export const REMOVE_WISHLIST_ITEMS_SUCCESS = "REMOVE_WISHLIST_ITEMS_SUCCESS";
export const REMOVE_WISHLIST_ITEMS_FAILURE = "REMOVE_WISHLIST_ITEMS_FAILURE";
